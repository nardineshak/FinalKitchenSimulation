...
public class MatchedSimulationRunnerTest {

    private MatchedSimulationRunner simulationRunner;
    ...
    public void setUp() {
        ...
        simulationRunner = new MatchedSimulationRunner(filePath, numCouriers);
        ...
        simulationRunner.setMatchedOrderConsumer(new MatchedOrderConsumer(readyOrdersQueue, courierReadyQueue, waitingCourierQueue, 10, allOrdersPrepared, notifyKitchenAllOrdersProcessed));
